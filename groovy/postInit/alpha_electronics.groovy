...
assembly_line.recipeBuilder()
    ...
    .outputs(item('contenttweaker:alpha_processor') * 4)
    .stationResearch(b -> b.researchStack(item('contenttweaker:delta_mainframe')).CWUt(48).EUt(512000))
    .EUt(1200000)
    .duration(6000)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs(
        ...
        item('contenttweaker:alpha_processor') * 4,
    ...
    .fluidInputs(fluid('naquadria') * 288)
    .outputs(item('contenttweaker:alpha_supercomputer') * 2)
    .stationResearch(b -> b.researchStack(item('contenttweaker:alpha_processor')).CWUt(64).EUt(768000))
    .EUt(2400000)
    .duration(8000)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs(
        ...
        item('contenttweaker:alpha_supercomputer') * 4,
    ...
    .outputs(item('contenttweaker:alpha_mainframe') * 1)
    .stationResearch(b -> b.researchStack(item('contenttweaker:alpha_supercomputer')).CWUt(80).EUt(10240000))
    .EUt(12000000)
    .duration(10000)
    .buildAndRegister();