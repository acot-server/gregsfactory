...
crafting.addShaped('Epic Gas Collector V', item('gregtech:machine:542') * 1,
    [
        [bars,Ffilter,bars],
        [pump,hull,pump],
...
//OpV Transformer
crafting.addShaped('OpV transformer', item('gregtech:machine:1282') * 1,
    [
        [UHPIC,item('gregtech:cable_single:32006'),item('gregtech:cable_single:32006')],
        [cable,hull,null],
        [UHPIC,item('gregtech:cable_single:32006'),item('gregtech:cable_single:32006')]
    ]);
...
assembler.recipeBuilder()
    ...
    .outputs(item('gregtech:machine:1297') * 1)
    .EUt(200000)
    .duration(300)
    .buildAndRegister();

//MAX Transformer
crafting.addShaped('MAX transformer', item('gregtech:machine:1283') * 1,
    [
        [UHPIC,item('gregtech:cable_hex:32007'),item('gregtech:cable_hex:32007')],
        [cable,hull,null],
        [UHPIC,item('gregtech:cable_hex:32007'),item('gregtech:cable_hex:32007')]
    ]);
...
assembler.recipeBuilder()
    .inputs(
        item('gregtech:machine:1283') * 1,
        pump * 1,
        cable * 1,
        item('gregtech:cable_hex:32007') * 1,
        Spring * 1,
        Sspring * 1
    )
    .fluidInputs(liquid4 * 2000)
    .outputs(item('gregtech:machine:1298') * 1)
    .EUt(200000)
    .duration(300)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    ...
    .stationResearch(b -> b.researchStack(metaitem('energy_hatch.input.uxv')).CWUt(144).EUt(147456000))
    .EUt(2000000)
    .duration(1000)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs([
        ...
        UHPIC * 2,
        circuitUXV * 1,
        metaitem('voltage_coil.uv') * 64,
        Sspring * 4
    ])
    .fluidInputs(liquid2 * 2880)
    .outputs(metaitem('energy_hatch.output.opv') * 1)
    .stationResearch(b -> b.researchStack(metaitem('energy_hatch.output.uxv')).CWUt(144).EUt(147456000))
    .EUt(2000000)
    .duration(1000)
    .buildAndRegister();
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output.opv') * 1,
        metaitem('transformer.opv') * 1,
        metaitem('omega.opv') * 1,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output_4a.opv') * 1,
        metaitem('transformer.adjustable.opv') * 2,
        metaitem('omega.opv') * 4,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output_16a.opv') * 1,
        metaitem('transformer.adjustable.opv') * 4,
        metaitem('omega.opv') * 16,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input.opv') * 1,
        metaitem('transformer.opv') * 1,
        metaitem('omega.opv') * 1,
        metaitem('cableGtDoubleRunicalloy') * 4,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input_4a.opv') * 1,
        metaitem('transformer.adjustable.opv') * 2,
        metaitem('omega.opv') * 4,
        metaitem('cableGtDoubleRunicalloy') * 16,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input_16a.opv') * 1,
        metaitem('transformer.adjustable.opv') * 4,
        metaitem('omega.opv') * 16,
        metaitem('cableGtDoubleRunicalloy') * 64,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        ...
        metaitem('cableGtDoubleRunicalloy') * 2
    )
    .circuitMeta(2)
...
assembler.recipeBuilder()
    .inputs(
        ...
        metaitem('cableGtQuadrupleRunicalloy') * 4
    )
    .circuitMeta(3)
