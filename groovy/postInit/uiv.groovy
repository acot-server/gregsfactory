...
def Plate = metaitem('plateStellarite'); //Runic Alloy Alloy Plate
def Rod = metaitem('stickStellarite'); //Runic Alloy Alloy Rod
def Lrod = metaitem('stickLongStellarite'); //Runic Alloy Alloy Long Rod
def Ring = metaitem('ringStellarite'); //Runic Alloy Alloy Ring
def Round = metaitem('roundStellarite'); //Runic Alloy Alloy Round
def Spring = metaitem('springStellarite'); //Runic Alloy Alloy Sping
def Sspring = metaitem('springSmallStellarite'); //Runic Alloy Alloy Small Spring
def Gear = metaitem('gearStellarite'); //Runic Alloy Alloy Gear
def Sgear = metaitem('gearSmallStellarite'); //Runic Alloy Alloy Small Gear
def Screw = metaitem('screwStellarite'); //Runic Alloy Alloy Screw
def FineW = metaitem('wireFineStellarite'); //Runic Alloy Alloy Fine Wire
def Rotor = metaitem('rotorStellarite'); //Runic Alloy Alloy Rotor
def foil = metaitem('foilStellarite'); //Runic Alloy Alloy Foil
def cable = metaitem('cableGtSingleStellarite'); //Runic Alloy Alloy Cable
def cable2 = metaitem('wireGtOctalStellarite'); //Runic Alloy Alloy Wire 8x
def Buzzsaw = metaitem('toolHeadBuzzSawStellarite'); //Runic Alloy Alloy Buzzsaw
def Bolt = metaitem('boltStellarite'); //Runic Alloy Bolt
...
crafting.addShaped('Epic Gas Collector III', item('gregtech:machine', 540) * 1,
    [
        [bars,Ffilter,bars],
        [pump,hull,pump],
...
//UIV Transformer
crafting.addShaped('UIV transformer', item('gregtech:machine', 1280) * 1,
    [
        [UHPIC,item('gregtech:cable_single', 32004),item('gregtech:cable_single', 32004)],
        [cable,hull,null],
        [UHPIC,item('gregtech:cable_single', 32004),item('gregtech:cable_single', 32004)]
    ]);
...
assembler.recipeBuilder()
    ...
    .outputs(item('gregtech:machine', 1295) * 1)
    .EUt(200000)
    .duration(300)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    ...
    .stationResearch(b -> b.researchStack(metaitem('energy_hatch.input.uev')).CWUt(96).EUt(9216000))
    .EUt(2000000)
    .duration(1000)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs(
        ...
        UHPIC * 2,
        circuitUIV * 1,
        metaitem('voltage_coil.uv') * 48,
        Sspring * 4
    )
    .fluidInputs(liquid2 * 2880)
    .outputs(metaitem('energy_hatch.output.uiv') * 1)
    .stationResearch(b -> b.researchStack(metaitem('energy_hatch.output.uev')).CWUt(96).EUt(9216000))
    .EUt(2000000)
    .duration(1000)
    .buildAndRegister();
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output.uiv') * 1,
        metaitem('transformer.uiv') * 1,
        metaitem('sigma.uiv') * 1,
        metaitem('cableGtDoubleDarkenergyalloy') * 4,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output_4a.uiv') * 1,
        metaitem('transformer.adjustable.uiv') * 2,
        metaitem('sigma.uiv') * 4,
        metaitem('cableGtDoubleDarkenergyalloy') * 16,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
    )
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output_16a.uiv') * 1,
        metaitem('transformer.adjustable.uiv') * 4,
        metaitem('sigma.uiv') * 16,
        metaitem('cableGtDoubleDarkenergyalloy') * 64,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
    )
    .fluidInputs(fluid('liquid_helium') * 32000)
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input.uiv') * 1,
        metaitem('transformer.uiv') * 1,
        metaitem('sigma.uiv') * 1,
        metaitem('cableGtDoubleDarkenergyalloy') * 4,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input_4a.uiv') * 1,
        metaitem('transformer.adjustable.uiv') * 2,
        metaitem('sigma.uiv') * 4,
        metaitem('cableGtDoubleDarkenergyalloy') * 16,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input_16a.uiv') * 1,
        metaitem('transformer.adjustable.uiv') * 4,
        metaitem('sigma.uiv') * 16,
        metaitem('cableGtDoubleDarkenergyalloy') * 64,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
