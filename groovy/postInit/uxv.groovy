...
crafting.addShaped("Epic Gas Collector IV", item('gregtech:machine:541') * 1,
    [
        [bars,Ffilter,bars],
        [pump,hull,pump],
...
//UXV Transformer
crafting.addShaped("UXV transformer", item('gregtech:machine:1281') * 1,
    [
        [UHPIC,item('gregtech:cable_single:32005'),item('gregtech:cable_single:32005')],
        [cable,hull,null],
        [UHPIC,item('gregtech:cable_single:32005'),item('gregtech:cable_single:32005')]
    ]);
...
assembler.recipeBuilder()
    ...
    .outputs(item('gregtech:machine:1296') * 1)
    .EUt(200000)
    .duration(300)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    ...
    .stationResearch(b -> b.researchStack(metaitem('energy_hatch.input.uiv')).CWUt(128).EUt(36864000))
    .EUt(2000000)
    .duration(1000)
    .buildAndRegister();
...
assembly_line.recipeBuilder()
    .inputs(
        ...
        UHPIC * 2,
        circuitUXV * 1,
        metaitem('voltage_coil.uv') * 56,
        Sspring * 4
    )
    .fluidInputs(liquid2 * 2880)
    .outputs(metaitem('energy_hatch.output.uxv') * 1)
    .stationResearch(b -> b.researchStack(metaitem('energy_hatch.output.uiv')).CWUt(128).EUt(36864000))
    .EUt(2000000)
    .duration(1000)
    .buildAndRegister();
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output.uxv') * 1,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output_4a.uxv') * 1,
        metaitem('transformer.adjustable.uxv') * 2,
        metaitem('phi.uxv') * 4,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.output_16a.uxv') * 1,
        metaitem('transformer.adjustable.uxv') * 4,
        metaitem('phi.uxv') * 16,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input.uxv') * 1,
        metaitem('transformer.uxv') * 1,
        metaitem('phi.uxv') * 1,
        metaitem('cableGtDoubleRunicalloy') * 4,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input_4a.uxv') * 1,
        metaitem('transformer.adjustable.uxv') * 2,
        metaitem('phi.uxv') * 4,
        metaitem('cableGtDoubleRunicalloy') * 16,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
...
assembler.recipeBuilder()
    .inputs(
        metaitem('energy_hatch.input_16a.uxv') * 1,
        metaitem('transformer.adjustable.uxv') * 4,
        metaitem('phi.uxv') * 16,
        metaitem('cableGtDoubleRunicalloy') * 64,
        metaitem('plate.ultra_high_power_integrated_circuit') * 64,
